...
var nameArray =[];
var customOrderOne=[{takeOut:"Fries"}];
var customOrderTwo=[{takeOut: "Shake"}];
// do your work below!

nameArray.push("Nick","Cadiente");
...
var updatedOrders= orderQueue.concat(customOrderOne, customOrderTwo);
